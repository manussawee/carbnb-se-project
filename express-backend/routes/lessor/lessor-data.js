...
const editRental = async (params, body) => {
    let errorRental, responseLessor
    try {
        responseLessor = await Rental.findOneAndUpdate(params, body, {new: true})
            .populate({
                path: 'car_id',
                populate: { path: 'car_image_ids' },
            })
